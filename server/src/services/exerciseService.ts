import type { DetectedEquipment, Exercise, Intensity, MuscleGroup, WorkoutRoutine } from "@gym-vision/shared";
import { bodyweightFallbacks } from "../data/bodyweightFallbacks";
import { resolveVideoForExercise } from "./youtubeService";
